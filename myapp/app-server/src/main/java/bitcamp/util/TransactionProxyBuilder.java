    ...
    public Object build(Object originalWorker) {
        ...
        return Proxy.newProxyInstance(
                ...
                new InvocationHandler() {
                    ...
                    // 프록시 객체의 메서드를 호출할 때
                    // @Transactional 이 붙은 메서드를 호출 할 떄는 TransactionTemplate 으로 처리하고
                    ...
                    Transactioal transactioal = originalMethod.getAnnotation(Transactioal.class);

                    if(transactioal != null){ // Transactional 애노테이션이 붙은 메서드라면
